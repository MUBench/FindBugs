...
public class MuBenchMethodFormatConverterTest {
	...
	private final MuBenchMethodFormatConverter extractor = new MuBenchMethodFormatConverter();
	...
	public void testEmptyParameter(){
		Assert.assertEquals(EmptyResult, extractor.convert(Empty));
	}
	...
	public void testBasicParameters(){
		Assert.assertEquals(SimpleBasicResult, extractor.convert(SimpleBasic));
	}
	...
	public void testArrayOfBasicParameters(){
		Assert.assertEquals(ArrayBasicResult, extractor.convert(ArrayBasic));
	}
	...
	public void testMixOfBasicParameters(){
		Assert.assertEquals(MixBasicResult, extractor.convert(MixBasic));
	}
	...
	public void testStringParameters(){
		Assert.assertEquals(SimpleStringResult, extractor.convert(SimpleString));
	}
	...
	public void testArrayOfStringParameters(){
		Assert.assertEquals(ArrayStringResult, extractor.convert(ArrayString));
	}
	...
	public void testMixOfStringParameters(){
		Assert.assertEquals(MixStringResult, extractor.convert(MixString));
	}
	...
	public void testMixOBasicAndStringParameters(){
		Assert.assertEquals(MixBasicAndStringResult, extractor.convert(MixBasicAndString));
	}
	...
	public void testCustomParameters(){
		Assert.assertEquals(SimpleCustomResult, extractor.convert(SimpleCustom));
	}
	...
	public void testArrayOfCustomParameters(){
		Assert.assertEquals(ArrayCustomResult, extractor.convert(ArrayCustom));
	}
	...
	public void testMixOBasicAndCustomParameters(){
		Assert.assertEquals(MixBasicAndCustomResult, extractor.convert(MixBasicAndCustom));
	}
	...
	public void testMixOfStriAndCustomParameters(){
		Assert.assertEquals(MixStringAndCustomBasicResult, extractor.convert(MixStringAndCustomBasic));
	}
	...
	public void testMixOfArrayOfStriAndCustomParameters(){
		Assert.assertEquals(MixStringAndCustomArrayResult, extractor.convert(MixStringAndCustomArray));
	}
	...
	public void testMixOfAllBasicParameters(){
		Assert.assertEquals(MixAllBasicResult, extractor.convert(MixAllBasic));
	}
	...
	public void testMixOfAllArrayOfParameters(){
		Assert.assertEquals(MixAllArrayResult, extractor.convert(MixAllArray));
	}
	...
	public void testCustomParametersHavingBasicCharacters(){
		Assert.assertEquals(SimpleCustomWithBasicCharactersResult, extractor.convert(SimpleCustomWithBasicCharacters));
	}
	...
	public void testArrayOfCustomParametersHavingBasicCharacters(){
		Assert.assertEquals(ArrayCustomWithBasicCharactersResult, extractor.convert(ArrayCustomWithBasicCharacters));
	}
